...
<body>
	 <div class="sidebar">
          ...
          <a class="active"  href="issueBook.jsp">Issue Book</a>
        ...
        <form action= "Another" method="get">
          <input type="hidden" name="name" value="issueBook">
  ...
  <div class="row mb-3">
    ...
    <div class="col-sm-10">
     <input type="text" id="book" class="form-control" name="bookname" required>
    </div>
  </div>
